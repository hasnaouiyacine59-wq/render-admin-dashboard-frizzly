"""
FRIZZLY Admin Dashboard - Direct Firebase Version
Uses direct Firebase connection via service account
"""
...
try:
    ...
    SERVICE_ACCOUNT_PATH = os.environ.get('SERVICE_ACCOUNT_PATH', '/etc/secrets/serviceAccountKey.json')
...
_CATEGORY_CACHE_TTL = 300 # Cache for 5 minutes
